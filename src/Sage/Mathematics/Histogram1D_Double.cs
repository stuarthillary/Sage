...
namespace Highpoint.Sage.Mathematics
{
    ...
    public sealed class Histogram1D_Double : Histogram1D_Base<double>
    {
        ...
        public Histogram1D_Double(double lowBound, double highBound, uint nBins, string name, Guid guid) : this(Array.Empty<double>(), lowBound, highBound, nBins, name, guid) { }
        public Histogram1D_Double(double lowBound, double highBound, uint nBins, string name) : this(Array.Empty<double>(), lowBound, highBound, nBins, name, Guid.Empty) { }
        public Histogram1D_Double(double lowBound, double highBound, uint nBins) : this(Array.Empty<double>(), lowBound, highBound, nBins, "", Guid.Empty) { }
